...
# Bot information
API_ID = environ.get('API_ID', '26795065')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5010934394')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001963002738').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001934104589')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001877411975')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://rjalexak47:Rohit7890@moviesfile.aled5ye.mongodb.net/?retryWrites=true&w=majority&appName=Moviesfile")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "3edc7ef69d59e9a36de616548cd4b61f75755a38")
